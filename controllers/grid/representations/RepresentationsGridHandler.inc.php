...
abstract class RepresentationsGridHandler extends CategoryGridHandler {
	...
	function setProofFileCompletion($args, $request) {
		...
		$confirmationText = __($submissionFile->getViewable()?'editor.submission.proofreading.confirmRemoveCompletion':'editor.submission.proofreading.confirmCompletion');
