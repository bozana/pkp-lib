 ...
 * @ingroup tools
 *
 * @brief CLI tool to copy, prepare and convert apache access log file into the new format needed for reprocessing.
 *
 ...
 *
 * Apache log files from the release 2.x are handled as following:
 *
 * Issue Galley:
 * with PDF viewer:
 ...
 * There is also only issue/download/issueId/galleyId.
 * without PDF viewer:
 ...
 * There is also only article/donwload/articleId/galleyId.
 * without PDF viewer:
...
. "  Usage: php {$this->scriptName} [path/to/apache/log/file.log]\n\n";
    ...
    /**
     * Split access log file by day. The new, daily files will be named to apache_usage_events_{day}.log
     *
