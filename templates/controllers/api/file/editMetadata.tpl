...
<div id="editFileMetadataTabs">
    <ul>
        ...
        <li><a href="{url router=$smarty.const.ROUTE_COMPONENT op="pubIds" fileId=$submissionFile->getFileId() revision=$submissionFile->getRevision() submissionId=$submissionFile->getSubmissionId() stageId=$stageId}">{translate key="submission.identifiers"}</a></li>
    </ul>
</div>
