...
class PKPStatsContextHandler extends APIHandler
{
    ...
    public function authorize($request, &$args, $roleAssignments)
    {
        ...
        if (in_array($routeName, ['get', 'getIndex'])) {
     ...
     */
    public function getManyIndex(\Slim\Http\Request $slimRequest, \PKP\core\APIResponse $response, array $args): \PKP\core\APIResponse
    {
        $defaultParams = [
     ...
     * month or day
     */
    public function getIndex(\Slim\Http\Request $slimRequest, \PKP\core\APIResponse $response, array $args): \PKP\core\APIResponse
    {
        $request = $this->getRequest();
    ...
    protected function getJSONItem(\Slim\Http\Request $slimRequest, int $contextId, int $contextViews): array
    {
        // Get basic context details for display
