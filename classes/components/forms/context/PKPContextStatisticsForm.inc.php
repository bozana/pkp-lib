    ...
    public function __construct($action, $locales, $site, $context)
    {
        ...
        $this->addGroup([
            ...
            ->addField(new FieldOptions('enableUsageStatsDisplay', [
                ...
                'default' => false,
                'value' => $context->getData('enableUsageStatsDisplay') !== null ? $context->getData('enableUsageStatsDisplay') : $site->getData('enableUsageStatsDisplay'),
            ]))
            ->addField(new FieldSelect('usageStatsDisplayChartType', [
                ...
                'default' => 'bar',
                'value' => $context->getData('usageStatsDisplayChartType') !== null ? $context->getData('usageStatsDisplayChartType') : $site->getData('usageStatsDisplayChartType'),
            ...
            ->addField(new FieldText('usageStatsDisplayMaxCount', [
                ...
                'groupId' => 'display',
                'default' => 4,
                'value' => $context->getData('usageStatsDisplayMaxCount') !== null ? $context->getData('usageStatsDisplayMaxCount') : $site->getData('usageStatsDisplayMaxCount'),
                'showWhen' => 'enableUsageStatsDisplay',
            ]));
    }
}
