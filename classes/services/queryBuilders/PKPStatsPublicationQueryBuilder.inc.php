...
class PKPStatsPublicationQueryBuilder extends PKPStatsQueryBuilder
{
    ...
    /** @var array Include records for these files */
     ...
     * @return \PKP\services\queryBuilders\PKPStatsPublicationQueryBuilder
     */
    public function filterByFiles($fileIds): self
    {
    ...
    {
        return parent::getSelectColumns($selectColumns);
    }
    ...
    protected function _getObject(): \Illuminate\Database\Query\Builder
    {
        ...
        if (!empty($this->fileIds)) {
            $q->whereIn(PKPStatisticsHelper::STATISTICS_DIMENSION_FILE_ID, $this->fileIds);
        }
