...
class PKPStatsPublicationService
{
    ...
    /**
     * Get total metrics for every submission, ordered desc by metrics, return just the requested offset
     */
    ...
    /**
     * Get total metrics for every submission file, ordered desc by metrics, return just the requested offset
     */
