...
class DAO extends EntityDAO
{
    ...
    public $schema = \PKP\services\PKPSchemaService::SCHEMA_INSTITUTION;
     ...
     */
    public function fromRow(stdClass $row): Institution
    {
    ...
    public function insert(Institution $institution): int
    {
        ...
        if (isset($ipRanges)) {
            $this->_insertIPRanges($institutionId, $ipRanges);
        }
    ...
    public function update(Institution $institution)
    {
        ...
        if (isset($ipRanges)) {
            $this->_deleteIPRanges($institution->getId());
            $this->_insertIPRanges($institution->getId(), $ipRanges);
        }
    }
    ...
    public function delete(Institution $institution)
    {
        ...
        $foreigKeyContrain = DB::table('institutional_subscriptions')
            ->where('institution_id', '=', $institution->getId())
            ->exists();
        if ($foreigKeyContrain) {
    ...
    /**
     * Internal function to insert institution IP ranges.
     */
    public function _insertIPRanges(int $institutionId, array $ipRanges)
    {
    ...
    /**
     * Internal function to delete institution IP ranges by institution ID.
     */
    public function _deleteIPRanges(int $institutionId)
    {
