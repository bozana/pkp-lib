...
abstract class PKPApplication implements iPKPApplicationInfoProvider
{
    ...
    public function getDAOMap()
    {
        return [
            ...
            'UsageStatsInstitutionTemporaryRecordDAO' => 'PKP\statistics\UsageStatsInstitutionTemporaryRecordDAO',
            'UsageStatsTotalTemporaryRecordDAO' => 'PKP\statistics\UsageStatsTotalTemporaryRecordDAO',
            'UsageStatsUniqueInvestigationsTemporaryRecordDAO' => 'PKP\statistics\UsageStatsUniqueInvestigationsTemporaryRecordDAO',
            'UsageStatsUniqueRequestsTemporaryRecordDAO' => 'PKP\statistics\UsageStatsUniqueRequestsTemporaryRecordDAO',
