        ...
        switch ($assocType) {
            case Application::ASSOC_TYPE_SUBMISSION_FILE:
                ...
                if ($this->isApacheAccessLogFile) {
                    ...
                    // We need to get the publication in order to be able to get galley by best ID
                    ...
                    $galley = Repo::galley()->getByBestId($representationUrlPath, $publication);
                    if (!$galley) {
                        echo "Represantation (galley or publication format) with the URL path or ID {$representationUrlPath} does not exist.\n";
                        break;
                    }
