...
abstract class Repository
{
     ...
     */
    public function getMinorVersionsWithSameDoi(SubmissionFile $submissionFile): LazyCollection
    {
        $publication = Repo::publication()->get($submissionFile->getData('publicationId'));
