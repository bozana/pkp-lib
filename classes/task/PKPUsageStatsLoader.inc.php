...
abstract class PKPUsageStatsLoader extends FileLoader
{
    ...
    /** List of months the processed log files are from, to consider for monthly aggregation */
    ...
    protected function processFile(string $filePath): bool|int
    {
        ...
        while (!feof($fhandle)) {
            ...
            // This should only happen for the log file of the installation/upgrade day
